...
<head>
  ...
  <title>Daftar - GardenHost</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <link rel="stylesheet" href="css/styles.css">
</head>
<body class="bg-slate-50 flex items-center justify-center min-h-screen">
  <div class="w-full max-w-md p-8">
    <div class="text-center mb-8"><h1 class="text-2xl font-bold">Daftar GardenHost</h1><p class="text-slate-500">Buat akun untuk mengelola layanan cloud Anda</p></div>
    <div class="bg-white p-8 rounded-2xl shadow-xl">
      ...
      <form action="/api/register.php" method="post" class="space-y-4">
        ...
        <div class="mt-2"><button class="w-full bg-green-700 hover:bg-green-800 text-white py-2 rounded">Daftar</button></div>
      </form>
      <div class="mt-4 text-center text-sm text-slate-600">Sudah punya akun? <a href="/index.php" class="text-green-700">Masuk</a></div>
    </div>
  </div>
</body>
</html>
